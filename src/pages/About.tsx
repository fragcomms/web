...
export default function About() {
  return (
    <div>
      ...
      <section
        id="hero"
        className="relative pt-20 md:pt-40 pb-24 px-6 overflow-hidden"
      >
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h2 className="text-lg md:text-xl text-[#cbd5e1] mt-6 mb-8 font-light">
            CS 426 Senior Project in Computer Science, Spring 2025, at UNR, CSE
            Department
          </h2>
          ...
          <div className="space-y-6 text-center max-w-3xl mx-auto">
            <p className="text-[#cbd5e1] leading-relaxed">
              This project focuses on the reliable synchronization of in-game
              communications from Counter-Strike 2 matches to a website after
              the game concludes. The intended user group for this project will
              be professionals, analysts, coaches, and many others who play CS2.
              The reason being that the current market is very bare in terms of
              analytical tools. Many services offer the same old service, which
              is map replay.
            </p>

            <p className="text-[#cbd5e1] leading-relaxed">
              However, we are adding a different dimension to our service where
              there will be audio automatically uploaded and synced to the
              replay if they are using our Discord bot. We are giving the user
              group a map replay with audio synced to the events that happen
              in-game and analyzing whether the communications were "good" or
              "bad". To do so, we will utilize Discord, WhisperX,
              LaihoE/demoparser, and many others. The listed names here are
              crucial to our project, and we cannot do without.
            </p>

            <p className="text-[#cbd5e1] leading-relaxed">
              We are developing the tool for universal use by any player, so
              anyone who is not a professional, analyst, coach, etc., can still
              utilize it. The project aims to improve the player's chemistry
              with their teams and/or specific players.
            </p>

            <p className="text-[#cbd5e1] leading-relaxed">
              Since people play CS2 globally, we should expect our product to
              remain reliable every day. Without reliability, most of the player
              base, which is not located in the Americas, wouldn't use our
              product as much. We will accomplish 24/7 availability by hosting
              the website on a VPS with caching abilities so that if the
              database goes down, the user can access their previously accessed
              replay.
            </p>

            <p className="text-[#cbd5e1] leading-relaxed">
              Security is a top priority for this project, as if there is any
              unauthorized access to communications, it will ruin a team's
              playbook. Only authorized users will be allowed to listen and read
              the transcriptions. In terms of safety, we will attempt to omit
              identifying information from the transcriptions/audio. However, it
              is a tall task, and so we will do the most with securing the
              replays to the accounts as much as possible so that no
              unauthorized person can freely access the data. To do so, we will
              tailor the SQL queries to guarantee user access. We will also
              block any user's IP address for a week if they try to do
      ...
      <section id="team" className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[#cbd5e1] text-center mb-12 max-w-2xl mx-auto">
            A diverse group of experts united by our passion for innovation and
            excellence.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] text-center">
              ...
              <p className="text-[#cbd5e1] mb-4">
                Sleep-deprived leader and CS player
              </p>
              <a
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] text-center">
              ...
              <p className="text-[#cbd5e1] mb-4">
                Balancing too many things at once
              </p>
              <a
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] text-center">
              ...
              <p className="text-[#cbd5e1] mb-4">
                Part-time coder and singer of the band Etiquette
              </p>
              <a
      ...
      <section id="advisors" className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[#cbd5e1] text-center mb-12 max-w-2xl mx-auto">
            This project was developed under the guidance of the following
            people.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] text-center">
              ...
              <p className="text-[#60a5fa] mb-2 font-medium">
                External Advisor
              </p>
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] text-center">
              ...
              <p className="text-[#cbd5e1]">
                Professor of Computer Science & Engineering at University of
                Nevada, Reno
              </p>
            </div>
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] text-center">
              ...
              <p className="text-[#60a5fa] mb-2 font-medium">Instructor</p>
              <p className="text-[#cbd5e1]">
                OIT Administrator & Instructor at University of Nevada, Reno
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="resources" className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[#cbd5e1] text-center mb-12 max-w-2xl mx-auto">
            The following are links to resources we utilized to build our
            project.
          </p>
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] hover:border-[#60a5fa] transition focus-within:ring-2 focus-within:ring-[#60a5fa]">
              ...
              <p className="text-[#cbd5e1]">
                Repository coded in Rust being used to parse Counter-Strike 2
                demo files.
              </p>
            </div>
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] hover:border-[#60a5fa] transition focus-within:ring-2 focus-within:ring-[#60a5fa]">
              ...
              <p className="text-[#cbd5e1]">
                Advanced speech recognition model for accurate audio
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] hover:border-[#60a5fa] transition focus-within:ring-2 focus-within:ring-[#60a5fa]">
              ...
              <p className="text-[#cbd5e1]">
                Platform for building bots and integrations to sync voice
                communications.
              </p>
            </div>
            ...
            <div className="bg-[#1e293b] rounded-lg p-6 border border-[#334155] hover:border-[#60a5fa] transition focus-within:ring-2 focus-within:ring-[#60a5fa]">
              ...
              <p className="text-[#cbd5e1]">
                Protocol buffer definitions for Steam communications and game
                data structures.
              </p>
            </div>
          </div>
