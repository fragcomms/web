...
export class ReplayPlayer {
  ...
  setReplay(data: ReplayJSON) {
    ...
    if (!Array.isArray(tl)) {
      console.error(
        "Replay JSON missing timeline array. Keys: ",
    ...
    this.endTick = this.timeline.length
      ? this.timeline[this.timeline.length - 1].tick
      : 0;
    this.elapsedSec = 0;
  ...
  private bracketTick(
    targetTick: number,
  ): { prev: TimelineTick; next: TimelineTick } | null {
