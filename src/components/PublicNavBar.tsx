...
const navLinkClass = "text-lg text-slate-300 hover:text-white transition-colors";
const loginClassName = "rounded-md bg-slate-700 px-5 py-2.5 text-base text-white transition-colors hover:bg-slate-600";
const navItems = [
